...
import ImageProj3 from '../svg/calculator.JPG'
import ImageProj5 from '../svg/dollar_reais_mobile.JPG'
import ImageProj6 from '../svg/dollars_reais_desktop.JPG'
...
const Home = ({ 
  titleHome, paragraphHome, buttonHome, 
  titleAboutMe, paragraphAboutMe, titleAboutMe2, p1, p2, p3, p4, p5, p6, p7, 
  titleProjects, titlePrj1, pProject1, titlePrj2, pProject2, access, titlePrj3, pProject3, 
  titleContact, paragraphContact, 
  titleThanks, paragraphThanks, onNavigate}) => {
      ...
      <div className={styles.container_project}>
        <div className={styles.div_proj}>
          ...
          <div className={styles.texts_project} id={styles.texts_project3}>
            <h1 className={styles.text_inter} id={styles.title_projects1}>{titlePrj3}</h1>
            <div className={styles.line_projects_p}></div>
            <p className={styles.text_openSans} id={styles.paragraph_projects1}>{pProject3}</p>
            <p className={styles.text_openSans} id={styles.acess2}>{access} <a href='https://milenaslv20.github.io/dollar-conversor/' target='_blank' className={styles.text_openSans}>https://milenaslv20.github.io/dollar-conversor/</a></p>
          </div>
          <img src={ImageProj5} alt='' className={styles.img_proj2} id={styles.img_proj5}></img>
          <img src={ImageProj6} alt='' className={styles.img_proj1} id={styles.img_proj6}></img>
